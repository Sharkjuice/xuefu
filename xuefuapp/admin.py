...
from xuefuapp.models import Car,Fee,Owner,GroundQueue,UndergroundQueue,ST_PASS, Port
...
class OwnerAdmin(admin.ModelAdmin):
    ...
    def save_model(self, request, obj, form, change):
        #API服务接口域名: 
        # if change:
        #     #url = "{}/{}?appId={}&appSecret={}".format(OwnerAdmin.DOMAIN_NAME, OwnerAdmin.TOKEN_PATH, OwnerAdmin.APP_ID, OwnerAdmin.APP_Secret)
...
class QueueAdmin(admin.ModelAdmin):
    ...
    search_fields = ('car__car_id','notes')
